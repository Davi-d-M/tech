              ...
              <div key={item.id} className="bg-white rounded-2xl p-4 border border-slate-100 shadow-sm flex items-center gap-4 sm:gap-6 group text-left">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-2 mt-4">
                    <Button
                      size="sm"
                      className="rounded-lg h-9 px-4 font-bold bg-primary text-white hover:bg-primary/90 transition-colors flex items-center gap-2 text-[10px] uppercase shadow-lg shadow-primary/20"

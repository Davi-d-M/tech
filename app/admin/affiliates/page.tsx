                ...
                <Card className="rounded-[3.5rem] border border-border bg-card shadow-sm overflow-hidden text-left">
                    <div className="p-10 border-b border-border flex flex-col gap-6 lg:flex-row lg:justify-between lg:items-center">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-2xl font-black text-foreground uppercase tracking-tighter">Protocol Directory</h2>
                        </div>
                                        ...
                                        <td className="px-10 py-8">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <span className="text-[9px] font-bold text-muted-foreground uppercase tracking-widest mt-0.5">{aff.email}</span>
                                                </div>
                                            </div>
                                        </td>

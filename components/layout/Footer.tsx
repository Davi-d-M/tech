      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3 text-sm text-muted-foreground">
                  ...
                  <span>+ (254)142422908 </span>
                </div>
                <div className="flex items-center gap-3 text-sm text-muted-foreground">
                  <Mail className="h-4 w-4 text-primary" />
                  <span>davidmaganga130@gmail.com</span>
                </div>
              </div>
        ...
        <div className="py-6 flex flex-col md:flex-row justify-between items-center gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Developed by <a href="https://github.com/Davi-d-M" target="_blank" rel="noopener noreferrer" className="font-bold hover:text-primary transition-colors">David Maganga</a> • Distributed by <a href="https://vercel.com/davi-d-ms-projects" target="_blank" rel="noopener noreferrer" className="font-bold hover:text-primary transition-colors">Vercel</a></p>
          </div>
